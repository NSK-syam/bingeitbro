...
export const TELUGU_THEMES: ChatTheme[] = [
  {
    ...
    bg: 'linear-gradient(160deg, rgba(8,0,0,0.1) 0%, rgba(10,0,0,0.4) 100%), url("https://image.tmdb.org/t/p/w1280/tSqvrZLsYQ6OnHALVvBKV6V9Ot0.jpg") center/cover no-repeat',
    bubble: 'rgba(239,68,68,0.5)',
    bubbleBorder: 'rgba(248,113,113,0.7)',
  },
  {
